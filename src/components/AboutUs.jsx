  ...
  const teamMembers = [
    {
      name: "Pranav Rajmane",
      role: "Founder & CEO",
      description: "B.Tech in Pyhsics from NIT Hamirpur. Passionate about pushing the boundaries of computational physics.",
      image: "PR"
    },
    {
      name: "Er. Harshvardhan Singh Shekhawat",
      role: "Co-Founder",
      description: "B.Tech in Chemical Engineering from NIT Hamirpur. Passionate about applying physics to real-world problems.",
      image: "HS"
    },
  ];
  ...
  const features = [
    {
      ...
      description: "State-of-the-art physics modeling with real-time computation",
      icon: "⚡"
    },
    {
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
            Join thousands of researchers and engineers who trust Noether Labs for their simulation needs.
          </p>
