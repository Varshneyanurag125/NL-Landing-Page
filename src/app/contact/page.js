            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                <input
                  ...
                  className="w-full px-3 py-2.5 bg-white/15 border border-white/20 rounded-lg text-white text-sm placeholder-gray-300 focus:outline-none focus:border-blue-400/60 focus:bg-white/20 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
              ...
              <div>
                <textarea
                  ...
                  required
                  disabled={isSubmitting}
                  className="w-full px-3 py-2.5 bg-white/15 border border-white/20 rounded-lg text-white text-sm placeholder-gray-300 focus:outline-none focus:border-blue-400/60 focus:bg-white/20 transition-colors duration-200 resize-none disabled:opacity-50 disabled:cursor-not-allowed"
                ></textarea>
              </div>
